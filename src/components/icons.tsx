...
export const TerminalIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
...
export const KaliLogo: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 32 32" fill="none">
    <path d="M16 2L3 8V16C3 23.5 8.5 30 16 32C23.5 30 29 23.5 29 16V8L16 2Z" fill="#1e293b" stroke="#367bf0" strokeWidth="2"/>
    <path d="M16 6L7 10.5V16C7 21.5 10.8 26.5 16 28C21.2 26.5 25 21.5 25 16V10.5L16 6Z" fill="#0f172a"/>
    <path d="M16 11V21M11 16H21" stroke="#00d9ff" strokeWidth="2" strokeLinecap="round"/>
    <circle cx="16" cy="16" r="3" fill="#367bf0"/>
  </svg>
);
